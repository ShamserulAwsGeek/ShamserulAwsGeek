# 🏄‍♂ [![Typing SVG](https://readme-typing-svg.herokuapp.com/?color=%2336BCF7&Center=true&VCenter=true&align=center&width=700&lines=Hey+lovely+folks+%F0%9F%91%8B,+I+am+Md+Shamserul+Haque;+Welcome+to+My+Profile!;AI/ML+Enthusiast;Always+learning+new+things+;Pro+AI+Practitioner)](https://git.io/typing-svg)
...
<br />
<h3 align="center"> A passionate AI/ML Engineer & pro Agentic AI Practitioner from Bengaluru,India</h3>
...
- 🔭 I'm very much passionate about AI/ML Engineering mainly into Agentic AI. As AI Enthusiast, I have achitected a ReAct-based Agentic AI pipeline using LangChain, LangGraph, and Azure OpenAI to enable multi-step pharmacy license verification with dynamic reasoning and intelligent tool orchestration. My expertise with AI/ML spans a wide range of services, enabling seamless deployment, management, and monitoring of cloud environments. Additionally, I work on healthcare domain specifically for policy-driven orchestration framework for claims processing that autonomously coordinates database operations, blob storage, RxClaims API integrations, notifications, and state transitions based on claim scenarios.I participate in Hacktoberfest every year and trying to get insight from Open Source Community.
